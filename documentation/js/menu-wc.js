...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">ecommerce-juegos-de-mesa-angular documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/Banner.html" data-type="entity-link" >Banner</a>
                            </li>
                            <li class="link">
                                <a href="components/CardCategory.html" data-type="entity-link" >CardCategory</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/Categories.html" data-type="entity-link" >Categories</a>
                            </li>
                            <li class="link">
                                <a href="components/Checkout.html" data-type="entity-link" >Checkout</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/Product.html" data-type="entity-link" >Product</a>
                            </li>
                            <li class="link">
                                <a href="components/Products.html" data-type="entity-link" >Products</a>
                            </li>
                            <li class="link">
